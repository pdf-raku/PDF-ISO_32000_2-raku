use v6;
role ISO_32000_2::Table_308-Entries_in_a_slideshow_dictionary {
    method Type {...};
    method Subtype {...};
    method Resources {...};
...
- (Required; PDF 1.4) A name tree that maps name strings to objects referenced by the alternate presentation. Even though PDF treats the strings in the name tree as strings without a specified encoding, the slideshow interprets them as UTF-8 encoded Unicode.
