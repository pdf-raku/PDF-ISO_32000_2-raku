use v6;
role ISO_32000_2::Table_317-Entries_in_a_ThreeD_background_dictionary {
    method Type {...};
    method Subtype {...};
    method CS {...};
    method C {...};
...
=head2 EA [boolean]
- (Optional) If true, the background applies to the entire annotation; if false, the background applies only to the rectangle specified by the annotation’s 3D view box (the 3DB entry in "Table 309 — Additional entries specific to a 3D annotation"). Default value: false.
