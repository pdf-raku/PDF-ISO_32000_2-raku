use v6;
role ISO_32000_2::Table_36-Entries_in_a_name_tree_node_dictionary {
    method Kids {...};
    method Names {...};
    method Limits {...};
}
...
=head2 Limits [array]
- (Required for intermediate and leaf nodes; not permitted in root nodes) Shall be an array of two strings, that specifies the (lexically) least and greatest keys included in the Names array of a leaf node or in the Names arrays of any leaf nodes that are descendants of an intermediate node.
