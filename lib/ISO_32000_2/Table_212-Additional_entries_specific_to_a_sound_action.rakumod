use v6;
role ISO_32000_2::Table_212-Additional_entries_specific_to_a_sound_action {
    method S {...};
    method Sound {...};
    method Volume {...};
    method Synchronous {...};
...
- (Optional) A flag specifying whether to play the sound synchronously or asynchronously. If this flag is true, the interactive PDF processor retains control, allowing no further user interaction other than cancelling the sound, until the sound has been completely played. Default value: false.
