use v6;
role ISO_32000_2::Table_34-Entries_in_a_resource_dictionary {
    method ExtGState {...};
    method ColorSpace {...};
    method Pattern {...};
    method Shading {...};
...
- (Optional) A dictionary that maps resource names to font dictionaries (see 9, "Text").

=head2 ProcSet [array]
- (Optional; deprecated in PDF 2.0) An array of predefined procedure set names (see 14.2, "Procedure sets").
