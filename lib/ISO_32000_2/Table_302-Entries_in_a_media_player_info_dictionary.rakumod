use v6;
role ISO_32000_2::Table_302-Entries_in_a_media_player_info_dictionary {
    method Type {...};
    method PID {...};
    method MH {...};
    method BE {...};
...
=head2 MH [dictionary]
- (Optional) A dictionary containing entries that is honoured for this dictionary to be considered viable
Currently, there are no defined entries for this dictionary

=head2 BE [dictionary]
- (Optional) A dictionary containing entries that need only be honoured in a "best effort" sense.
Currently, there are no defined entries for this dictionary
