use v6;
role ISO_32000_2::Table_110-Entries_in_a_Type_3_font_dictionary {
    method Type {...};
    method Subtype {...};
    method Name {...};
    method FontBBox {...};
...
=head2 Name [name]
- (Required in PDF 1.0; optional otherwise) See "Table 109 — Entries in a Type 1 font dictionary".

=head2 FontBBox [rectangle]
- (Required) A rectangle (see 7.9.5, "Rectangles") expressed in the glyph coordinate system, specifying the font bounding box. This is the smallest rectangle enclosing all marks that would result if all of the glyphs of the font were placed with their origins coincident and their descriptions executed.
If all four elements of the rectangle are zero, a PDF processor makes no assumptions about glyph sizes based on the font bounding box. If any element is non-zero, the font bounding box is accurate. If any glyph’s marks fall outside this bounding box, behaviour is implementation dependent and may not match the creator’s expectations.
...
=head2 Encoding [dictionary]
- (Required) An encoding dictionary whose Differences array specifies the complete character encoding for this font (see 9.6.5, "Character encoding").
