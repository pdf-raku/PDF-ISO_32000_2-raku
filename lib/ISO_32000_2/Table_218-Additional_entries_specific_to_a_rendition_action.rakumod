use v6;
role ISO_32000_2::Table_218-Additional_entries_specific_to_a_rendition_action {
    method S {...};
    method R {...};
    method AN {...};
    method OP {...};
...
- (Required if OP is not present; otherwise optional) A text string or stream containing an ECMAScript script that is executed when the action is triggered.
