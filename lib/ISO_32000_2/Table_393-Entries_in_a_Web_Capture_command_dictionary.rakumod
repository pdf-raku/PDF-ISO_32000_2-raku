use v6;
role ISO_32000_2::Table_393-Entries_in_a_Web_Capture_command_dictionary {
    method URL {...};
    method L {...};
    method F {...};
    method P {...};
...
=head2 F [integer]
- (Optional) A set of flags specifying various characteristics of the command (see "Table 393 — Entries in a Web Capture command dictionary"). Default value: 0.
