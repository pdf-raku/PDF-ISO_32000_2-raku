use v6;
role ISO_32000_2::Table_165-Entries_in_a_navigation_node_dictionary {
    method Type {...};
    method NA {...};
    method PA {...};
    method Next {...};
...
=head2 Dur [number]
- (Optional) The maximum number of seconds before the interactive PDF processor shall automatically advance forward to the next navigation node. If this entry is not specified, no automatic advance occurs.
