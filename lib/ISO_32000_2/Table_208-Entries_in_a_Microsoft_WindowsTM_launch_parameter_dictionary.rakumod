use v6;
role ISO_32000_2::Table_208-Entries_in_a_Microsoft_WindowsTM_launch_parameter_dictionary {
    method F {...};
    method D {...};
    method O {...};
    method P {...};
...
=head2 F [byte string]
- (Required) The file name of the application that is launched or the document that is opened or printed, in standard Microsoft WindowsTM specific pathname format. If the name string includes a backslash character (\), the backslash is itself be preceded by a backslash.
