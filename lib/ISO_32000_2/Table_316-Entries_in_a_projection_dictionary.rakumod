use v6;
role ISO_32000_2::Table_316-Entries_in_a_projection_dictionary {
    method Subtype {...};
    method CS {...};
    method F {...};
    method N {...};
...
=head2 N [number]
- (Required if Subtype is P; meaningful only if the value of CS is XNF) The near clipping distance, expressed in the camera coordinate system. No parts of objects whose z coordinates are less than the value of this entry are drawn. If Subtype is P, the value is positive; if Subtype is O, the value is non-negative, and the default value is 0.
