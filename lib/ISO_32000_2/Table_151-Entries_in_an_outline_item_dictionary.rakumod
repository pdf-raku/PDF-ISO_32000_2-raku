use v6;
role ISO_32000_2::Table_151-Entries_in_an_outline_item_dictionary {
    method Title {...};
    method Parent {...};
    method Prev {...};
    method Next {...};
...
=head2 F [integer]
- (Optional; PDF 1.4) A set of flags specifying style characteristics for displaying the outline item’s text (see "Table 152 — Outline item flags"). Default value: 0.
