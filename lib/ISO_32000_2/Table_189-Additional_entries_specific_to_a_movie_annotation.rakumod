use v6;
role ISO_32000_2::Table_189-Additional_entries_specific_to_a_movie_annotation {
    method Subtype {...};
    method T {...};
    method Movie {...};
    method A {...};
...
=head2 T [text string]
- (Optional) The title of the movie annotation. Movie actions (12.6.4.10, "Movie actions") may use this title to reference the movie annotation.
