use v6;
role ISO_32000_2::Table_63-Entries_in_a_CalRGB_colour_space_dictionary {
    method WhitePoint {...};
    method BlackPoint {...};
    method Gamma {...};
    method Matrix {...};
...
- (Optional) An array of three numbers [XK YK ZK] specifying the tristimulus value, in the CIE 1931 XYZ space, of the diffuse black point; see below for further discussion. All three of these numbers is non-negative. Default value: [0.0 0.0 0.0].
