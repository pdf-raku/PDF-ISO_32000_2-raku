use v6;
role ISO_32000_2::Table_268-Entries_in_a_number_format_dictionary {
    method Type {...};
    method U {...};
    method C {...};
    method F {...};
...
=head2 U [text string]
- (Required) A text string specifying a label for displaying the units represented by this dictionary in a user interface; the label uses a universally recognised abbreviation.

=head2 C [number]
- (Required) The conversion factor used to multiply a value in partial units of the previous number format array element to obtain a value in the units of this dictionary. When this entry is in the first number format dictionary in the array, its meaning (that is, what it is multiplied by) depends on which entry in the rectilinear measure dictionary (see "Table 267 — Additional entries in a rectilinear measure dictionary") references the number format array.
...
When the value of F is F, this entry is the denominator of a fractional display. The fraction may be reduced unless the value of FD is true.
Default value: 16.
