use v6;
role ISO_32000_2::Table_305-Additional_entries_specific_to_a_sound_object {
    method Type {...};
    method R {...};
    method C {...};
    method B {...};
...
=head2 CO [name]
- (Optional) The sound compression format used on the sample data. (This is separate from any stream compression specified by the sound object’s Filter entry; see "Table 5 — Entries common to all stream dictionaries" and 7.4, "Filters") If this entry is absent, sound compression is not used; the data contains sampled waveforms that is played at R samples per second per channel.
