use v6;
role ISO_32000_2::Table_71-Entries_in_a_DeviceN_process_dictionary {
    method ColorSpace {...};
    method Components {...};
}
...
- (Required) A name or array identifying the process colour space, which may be any device or CIE-based colour space except Lab. If an ICCBased colour space is specified, it provides calibration information appropriate for the process colour components specified in the names array of the DeviceN colour space.
