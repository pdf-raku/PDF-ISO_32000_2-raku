use v6;
role ISO_32000_2::Table_381-Standard_layout_attributes_specific_to_standard_column_attributes {
    method ColumnCount {...};
    method ColumnGap {...};
    method ColumnWidths {...};
}
...
- (Optional; not inheritable; PDF 1.6) The number of columns in the content of the grouping element.
Default value: 1.
