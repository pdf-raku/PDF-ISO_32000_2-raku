use v6;
role ISO_32000_2::Table_119-Entries_in_a_Type_0_font_dictionary {
    method Type {...};
    method Subtype {...};
    method BaseFont {...};
    method Encoding {...};
...
- (Optional) A stream containing a CMap file that maps character codes to Unicode values (see 9.9.2, "Font subsets").
