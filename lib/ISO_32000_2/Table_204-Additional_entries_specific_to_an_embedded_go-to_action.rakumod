use v6;
role ISO_32000_2::Table_204-Additional_entries_specific_to_an_embedded_go-to_action {
    method S {...};
    method F {...};
    method D {...};
    method NewWindow {...};
...
- (Optional) If true, the destination document is opened in a new window; if false, the destination document replaces the current document in the same window. If this entry is absent, the interactive PDF processor should act according to its preference.

=head2 T [dictionary]
- (Optional if F is present; otherwise required) A target dictionary (see "Table 205 — Entries specific to a target dictionary") specifying path information to the target document. Each target dictionary specifies one element in the full path to the target and may have nested target dictionaries specifying additional elements.
