use v6;
role ISO_32000_2::Table_306-Entries_in_a_movie_dictionary {
    method F {...};
    method Aspect {...};
    method Rotate {...};
    method Poster {...};
...
The format of a self-describing movie file is left unspecified, and there is no guarantee of portability.
...
- (Optional) A flag or stream specifying whether and how a poster image representing the movie is displayed. If this value is a stream, it contains an image XObject (see 8.9, "Images") to be displayed as the poster. If it is the boolean value true, the poster image is retrieved from the movie file; if it is false, no poster is displayed. Default value: false.
