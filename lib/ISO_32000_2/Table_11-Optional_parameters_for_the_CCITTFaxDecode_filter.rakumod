use v6;
role ISO_32000_2::Table_11-Optional_parameters_for_the_CCITTFaxDecode_filter {
    method K {...};
    method EndOfLine {...};
...
V<=> 0 Pure one-dimensional encoding (Group 3, 1-D)
...
- A flag indicating whether bits with a value of 1 is interpreted as black pixels and 0 bits as white pixels, the reverse of the normal PDF syntactic convention for image data. Default value: false.
