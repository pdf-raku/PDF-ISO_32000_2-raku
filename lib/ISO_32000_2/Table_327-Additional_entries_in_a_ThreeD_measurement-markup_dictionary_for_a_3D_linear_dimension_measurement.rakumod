use v6;
role ISO_32000_2::Table_327-Additional_entries_in_a_ThreeD_measurement-markup_dictionary_for_a_3D_linear_dimension_measurement {
    method AP {...};
    method A1 {...};
    method N1 {...};
    method A2 {...};
...
=head2 C [array]
- (Optional; PDF 2.0) An array of three numbers in the range 0.0 to 1.0 that represent the DeviceRGB colour of the measurement markup.
...
This value is converted to a text string and displayed as part of the measurement text string.

=head2 U [text string]
- (Required; PDF 2.0) A text string, called the units string, which represents the units for the measurement.
