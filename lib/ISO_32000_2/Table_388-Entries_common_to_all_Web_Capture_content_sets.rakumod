use v6;
role ISO_32000_2::Table_388-Entries_common_to_all_Web_Capture_content_sets {
    method Type {...};
    method S {...};
    method ID {...};
    method O {...};
...
- (Required) The digital identifier of the content set (see Digital identifiers").
...
- (Optional) The content type, an ASCII string characterising the source from which the objects belonging to the content set were created. The string conforms to the content type specification described in Internet RFC 2045.
EXAMPLE For a page set consisting of a group of PDF pages created from an HTML file, the content type would be text/html.

=head2 TS [date]
- (Optional) A timestamp giving the date and time at which the content set was created.
