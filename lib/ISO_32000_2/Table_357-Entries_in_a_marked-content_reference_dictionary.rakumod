use v6;
role ISO_32000_2::Table_357-Entries_in_a_marked-content_reference_dictionary {
    method Type {...};
    method Pg {...};
    method Stm {...};
    method StmOwn {...};
...
=head2 StmOwn [(any)]
- (Optional; is an indirect reference) The indirect reference to the PDF object referencing the stream identified by the Stm key.
