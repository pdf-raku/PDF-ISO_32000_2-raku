use v6;
role ISO_32000_2::Table_38-Entries_common_to_all_function_dictionaries {
    method FunctionType {...};
    method Domain {...};
    method Range {...};
}
