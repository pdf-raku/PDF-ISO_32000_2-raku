use v6;
role ISO_32000_2::Table_168-Entries_in_a_border_style_dictionary {
    method Type {...};
    method W {...};
    method S {...};
    method D {...};
...
An interactive PDF processor tolerates other border styles that it does not recognise and uses the default value (which is S).
