use v6;
role ISO_32000_2::Table_250-Entries_in_an_icon_fit_dictionary {
    method SW {...};
    method S {...};
    method A {...};
    method FB {...};
...
P Proportional scaling: Scale the icon to fit the width or height of the annotation rectangle while maintaining the icon’s original aspect ratio. If the required horizontal and vertical scaling factors are different, use the smaller of the two, centring the icon within the annotation rectangle in the other dimension.
Default value: P.
